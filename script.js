const quizData = [
    ...
    { type: "multiple", question: "10. 용식이의 군대 선임/동기가 아닌 사람은?", options: ["정우", "우진", "민재", "지우", "현택", "은한"], correct: [1,2] },
    { type: "audio", question: "11. 이때 우리는 뭘 타고 있었을까요?", audio: "타이를베이슨.MOV", options: ["지하철", "자동차", "스쿠터", "자전거"], correct: 3 },
    { type: "image", question: "12. 이 사진을 찍은 장소는 어디일까요?", img: "costco.jpg", options: ["Gaints", "Costco", "Target", "AlDI"], correct: 1 },
